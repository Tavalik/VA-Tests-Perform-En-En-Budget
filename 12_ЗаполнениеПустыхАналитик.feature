...
Сценарий: 12.03 Создаем экземпляр отчета без записи и заполнения аналитик
	...
	* Сравниваем результат
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| "Source"                        | '1,000'          | ''     | '0'               | '2/1/2024' | '0'            | ''     | '1,000' | ''     |
			| ' '                               | '1,000'          | ''     | '0'               | '2/1/2024' | '0'            | ''     | '1,000' | ''     |
			| ' '                               | '1,000'          | ''     | '0'               | '2/1/2024' | '0'            | ''     | '1,000' | ''     |
			| "SuccessorSameAnalytics"            | '1,000'          | ''     | '0'               | '2/1/2024' | '0'            | ''     | '1,000' | ''     |
			| ' '                               | '1,000'          | ''     | '0'               | '2/1/2024' | '0'            | ''     | '1,000' | ''     |
			| ' '                               | '1,000'          | ''     | '0'               | '2/1/2024' | '0'            | ''     | '1,000' | ''     |
			| "SuccessorEmptyAnalytics"          | '1,000'          | ''     | '0'               | '2/1/2024' | '0'            | ''     | '1,000' | ''     |
			| ' '                               | '1,000'          | ''     | '0'               | '2/1/2024' | '0'            | ''     | '1,000' | ''     |
			| ' '                               | '1,000'          | ''     | '0'               | '2/1/2024' | '0'            | ''     | '1,000' | ''     |
...
Сценарий: 12.04 Создаем экземпляр отчета без записи с заполнением аналитик
	...
	* Сравниваем результат
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| ''                                | "January 2024" | ''           | "February 2024" | ''           | "March 2024" | ''           | "TOTAL" | ''     |
			| ''                                | "Amount"          | "Date"       | "Amount"           | "Date"       | "Amount"        | "Date"       | "Amount" | "Date" |
			| "Source"                        | '100'            | '1/1/2024' | '200'             | '2/1/2024' | '300'          | '3/1/2024' | '600'   | ''     |
			| "Software products "           | '100'            | '1/1/2024' | '200'             | '2/1/2024' | '300'          | '3/1/2024' | '600'   | ''     |
			| ' '                               | '100'            | '1/1/2024' | '0'               | ''           | '0'            | ''           | '100'   | ''     |
			| "5C:Corporate performance management "      | '0'              | ''           | '200'             | '2/1/2024' | '0'            | ''           | '200'   | ''     |
			| "1C:ERP. Corporate performance management "   | '0'              | ''           | '0'               | ''           | '300'          | '3/1/2024' | '300'   | ''     |
			| "SuccessorSameAnalytics"            | '100'            | '1/1/2024' | '200'             | '2/1/2024' | '300'          | '3/1/2024' | '600'   | ''     |
			| "Software products "           | '100'            | '1/1/2024' | '200'             | '2/1/2024' | '300'          | '3/1/2024' | '600'   | ''     |
			| ' '                               | '100'            | '1/1/2024' | '0'               | ''           | '0'            | ''           | '100'   | ''     |
			| "5C:Corporate performance management "      | '0'              | ''           | '200'             | '2/1/2024' | '0'            | ''           | '200'   | ''     |
			| "1C:ERP. Corporate performance management "   | '0'              | ''           | '0'               | ''           | '300'          | '3/1/2024' | '300'   | ''     |
			| "SuccessorEmptyAnalytics"          | '100'            | '1/1/2024' | '200'             | '2/1/2024' | '300'          | '3/1/2024' | '600'   | ''     |
			| "Software products "           | '100'            | '1/1/2024' | '200'             | '2/1/2024' | '300'          | '3/1/2024' | '600'   | ''     |
			| ' '                               | '100'            | '1/1/2024' | '0'               | ''           | '0'            | ''           | '100'   | ''     |
			| "5C:Corporate performance management "      | '0'              | ''           | '200'             | '2/1/2024' | '0'            | ''           | '200'   | ''     |
			| "1C:ERP. Corporate performance management "   | '0'              | ''           | '0'               | ''           | '300'          | '3/1/2024' | '300'   | ''     |
