...
Сценарий: 07.02 Создание вида отчета "VA - Non-Numbers (source)"
	...
	И я в конструкторе отчета в ячейке 'R2C4' меняю свойство показателя 'TotalKind' на "Total to аналитикам не рассчитывается"
...
Сценарий: 07.03 Создание вида отчета "VA - Non-Numbers (recipient)"
	...
	* Проверяем и меняем итоги
		...
		Тогда элемент формы с именем 'TotalKind' стал равен "Total to аналитикам не рассчитывается"
		И выпадающий список с именем 'TotalKind' содержит значения
			| "Total to аналитикам не рассчитывается" |
			| "Minimum" |
			| "Maximum" |	
...
Сценарий: 07.05 Создание вида отчета "VA - Grouping by analytics"
	...
	* Меняем настройки показателей
		...
		* БезИтога
			И я в конструкторе отчета в ячейке 'R3C6' меняю свойство показателя 'TotalKind' на "Total to аналитикам не рассчитывается"
			И я в конструкторе отчета в ячейке 'R4C6' меняю свойство показателя 'TotalKind' на "Total to аналитикам не рассчитывается"
