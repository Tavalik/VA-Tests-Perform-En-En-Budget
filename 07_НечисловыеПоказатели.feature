...
Сценарий: 07.07 Создание экземпляра отчета - "VA - Non-Numbers (source)" 
	...
	* Сравниваем итоговый документ
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| ''                                                                | "January 2024" | ''                | ''               | ''        | "February 2024" | ''                | ''               | ''        | "March 2024" | ''                | ''               | ''        | "TOTAL" | ''                | ''               | ''        |
			| ''                                                                | "Price"           | "DateInflow" | "IncludeInPrice" | "Product ID" | "Price"            | "DateInflow" | "IncludeInPrice" | "Product ID" | "Price"         | "DateInflow" | "IncludeInPrice" | "Product ID" | "Price"  | "DateInflow" | "IncludeInPrice" | "Product ID" |
			| "Goods"                                                          | '1,206,000'      | '1/1/2024'      | "No"            | ''        | '1,326,600'       | '1/2/2024'      | "No"            | ''        | '1,326,600'    | '1/2/2024'      | "No"            | ''        | '0'     | '1/1/2024'      | "No"            | ''        |
			| "5C:Corporate performance management "                                      | '1,250,000'      | '1/1/2024'      | "Yes"             | '000001'  | '2,145,000'       | '5/2/2024'      | "Yes"             | '2000005' | '2,145,000'    | '5/2/2024'      | "Yes"             | '2000005' | '0'     | '1/1/2024'      | "No"            | ''        |
			| "2C:Corporation "                                                  | '2,050,000'      | '2/1/2024'      | "Yes"             | '000002'  | '2,255,000'       | ''                | "No"            | ''        | '2,255,000'    | ''                | "No"            | ''        | '0'     | '2/1/2024'      | "No"            | ''        |
			| "4C:Enterprise 8.3 CORP. Server License (x86-64) "           | '180,000'        | '3/1/2024'      | "Yes"             | '000003'  | '198,000'         | ''                | "No"            | ''        | '198,000'      | ''                | "No"            | ''        | '0'     | '3/1/2024'      | "No"            | ''        |
			| "1C:ERP. Corporate performance management "                                   | '1,950,000'      | '4/1/2024'      | "Yes"             | '000004'  | '660,000'         | '1/2/2024'      | "Yes"             | '2000001' | '660,000'      | '1/2/2024'      | "Yes"             | '2000001' | '0'     | '1/2/2024'      | "No"            | ''        |
			| "3C:Enterprise 8 CORP. Client license for 100 users " | '600,000'        | '5/1/2024'      | "Yes"             | '000005'  | '1,375,000'       | ''                | "No"            | ''        | '1,375,000'    | ''                | "No"            | ''        | '0'     | '5/1/2024'      | "No"            | ''        |
...
Сценарий: 07.11 Создание экземпляра отчета - "VA - Calculation in code" 
	...
	* Рассчитываем документ и сверяем результат
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| "Source"                                                        | '6,030,000'      | '5/1/2024' | "Yes"     | ''                                                                 | '6,633,000'       | '5/2/2024' | "Yes"     | ''                                                                  | '6,633,000'    | '5/2/2024' | "Yes"     | ''                                                               | '19,296,000' | '5/2/2024' | "Yes"     | ''       |
			...
			| "SourceCode"                                                     | '6,030,000'      | '5/1/2024' | "Yes"     | '000005'                                                           | '6,633,000'       | '5/2/2024' | "Yes"     | '2000005'                                                           | '6,633,000'    | '5/2/2024' | "Yes"     | '2000005'                                                        | '19,296,000' | '5/2/2024' | "Yes"     | ''       |
			| "DestinationCode"                                                     | '0'              | ''           | "No"    | ''                                                                 | '0'               | ''           | "No"    | ''                                                                  | '0'            | ''           | "No"    | ''                                                               | '0'          | ''           | "No"    | ''       |
			| "FormulasCode"                                                      | '1'              | '12/1/2023' | "Yes"     | "Mercury LLC\nVA - Main scenario\nRUB\nJanuary 2024\nMonth" | '2'               | '1/1/2024' | "No"    | "Mercury LLC\nVA - Main scenario\nRUB\nFebruary 2024\nMonth" | '3'            | '2/1/2024' | "No"    | "Mercury LLC\nVA - Main scenario\nRUB\nMarch 2024\nMonth" | '6'          | '2/1/2024' | "Yes"     | ''       |
			| "Calculation"                                                          | '6,030,000'      | '6/1/2024' | "No"    | ''                                                                 | '13,266,000'      | '6/2/2024' | "Yes"     | ''                                                                  | '19,899,000'   | '6/2/2024' | "No"    | ''                                                               | '39,195,000' | '6/2/2024' | "Yes"     | ''       |
	...
	* Рассчитываем документ еще раз и сверяем изменившийся результат
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| "3C:Enterprise 8 CORP. Client license for 100 users " | '600,000'        | '5/1/2024' | "Yes"     | '000005'                                                           | '1,375,000'       | ''           | "No"    | ''                                                                  | '1,375,000'    | ''           | "No"    | ''                                                               | '3,350,000'  | '5/1/2024' | "Yes"     | ''       |
			| "SourceCode"                                                     | '6,030,000'      | '5/1/2024' | "Yes"     | '000005'                                                           | '6,633,000'       | '5/2/2024' | "Yes"     | '2000005'                                                           | '6,633,000'    | '5/2/2024' | "Yes"     | '2000005'                                                        | '19,296,000' | '5/2/2024' | "Yes"     | ''       |
			| "DestinationCode"                                                     | '6,030,000'      | '5/1/2024' | "Yes"     | '000005'                                                           | '6,633,000'       | '5/2/2024' | "Yes"     | '2000005'                                                           | '6,633,000'    | '5/2/2024' | "Yes"     | '2000005'                                                        | '19,296,000' | '5/2/2024' | "Yes"     | ''       |
			| "FormulasCode"                                                      | '1'              | '12/1/2023' | "Yes"     | "Mercury LLC\nVA - Main scenario\nRUB\nJanuary 2024\nMonth" | '2'               | '1/1/2024' | "No"    | "Mercury LLC\nVA - Main scenario\nRUB\nFebruary 2024\nMonth" | '3'            | '2/1/2024' | "No"    | "Mercury LLC\nVA - Main scenario\nRUB\nMarch 2024\nMonth" | '6'          | '2/1/2024' | "Yes"     | ''       |
			| "Calculation"                                                          | '6,030,000'      | '6/1/2024' | "No"    | ''                                                                 | '13,266,000'      | '6/2/2024' | "Yes"     | ''                                                                  | '19,899,000'   | '6/2/2024' | "No"    | ''                                                               | '39,195,000' | '6/2/2024' | "Yes"     | ''       |
			| "5C:Corporate performance management "                                      | '1,250,000'      | '2/1/2024' | "No"    | '!!! 000001'                                                       | '4,290,000'       | '6/2/2024' | "No"    | '!!! 2000005'                                                       | '6,435,000'    | '6/2/2024' | "No"    | '!!! 2000005'                                                    | '11,975,000' | '6/2/2024' | "No"    | ''       |
			| "2C:Corporation "                                                  | '2,050,000'      | '3/1/2024' | "No"    | '!!! 000002'                                                       | '4,510,000'       | ''           | "Yes"     | ''                                                                  | '6,765,000'    | ''           | "No"    | ''                                                               | '13,325,000' | '3/1/2024' | "Yes"     | ''       |
