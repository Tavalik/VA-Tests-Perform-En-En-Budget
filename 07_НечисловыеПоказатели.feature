...
Сценарий: 07.03 Создание вида отчета "VA - Non-Numbers (recipient)"
	...
	* Проверяем и меняем итоги
		...
		Тогда элемент формы с именем 'TotalKind' стал равен "Cannot calculate the total by group drilldown"
		И выпадающий список с именем 'TotalKind' содержит значения
			| "Cannot calculate the total by group drilldown" |
			| "Minimum" |
			| "Maximum" |	
		И из выпадающего списка с именем 'TotalKind' я выбираю точное значение "Maximum"	
		Тогда элемент формы с именем 'PeriodTotalCalcMethod' стал равен "Total by period is not calculated"
		И выпадающий список с именем 'PeriodTotalCalcMethod' содержит значения
			| "Total by period is not calculated" |		
...
Сценарий: 07.05 Создание вида отчета "VA - Grouping by analytics"
	...
	* Меняем настройки показателей
		* Сумма
			И я в конструкторе отчета в ячейке 'R2C2' меняю свойство показателя 'PeriodTotalCalcMethod' на "Amount (turnover)"
			И я в конструкторе отчета в ячейке 'R3C2' меняю свойство показателя 'PeriodTotalCalcMethod' на "Amount (turnover)"
		...
		* Максимум
			...
			И я в конструкторе отчета в ячейке 'R3C3' меняю свойство показателя 'PeriodTotalCalcMethod' на "Amount (turnover)"
		...
		* Минимум
			И я в конструкторе отчета в ячейке 'R2C4' меняю свойство показателя 'PeriodTotalCalcMethod' на "Total by period is not calculated"
			И я в конструкторе отчета в ячейке 'R3C4' меняю свойство показателя 'PeriodTotalCalcMethod' на "Amount (turnover)"
			...
			И я в конструкторе отчета в ячейке 'R3C4' меняю свойство показателя 'TotalKind' на "Minimum"
		* Среднее
			И я в конструкторе отчета в ячейке 'R3C5' меняю свойство показателя 'PeriodTotalCalcMethod' на "Amount (turnover)"
		...
		* БезИтога
			...
			И я в конструкторе отчета в ячейке 'R3C6' меняю свойство показателя 'PeriodTotalCalcMethod' на "Amount (turnover)"
...
Сценарий: 07.07 Создание экземпляра отчета - "VA - Non-Numbers (source)" 
	...
	* Сравниваем итоговый документ
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| ''                                                                | "January 2024" | ''                | ''               | ''        | "February 2024" | ''                | ''               | ''        | "March 2024" | ''                | ''               | ''        | "TOTAL" | ''                | ''               | ''        |
			| ''                                                                | "Price"           | "DateReceipts" | "IncludeInPrice" | "Product ID" | "Price"            | "DateReceipts" | "IncludeInPrice" | "Product ID" | "Price"         | "DateReceipts" | "IncludeInPrice" | "Product ID" | "Price"  | "DateReceipts" | "IncludeInPrice" | "Product ID" |
			| "Goods"                                                          | '1,206,000'      | '1/1/2024'      | "No"            | ''        | '1,326,600'       | '1/2/2024'      | "No"            | ''        | '1,326,600'    | '1/2/2024'      | "No"            | ''        | '0'     | ''                | "No"            | ''        |
			| "5C:Corporate performance management "                                      | '1,250,000'      | '1/1/2024'      | "Yes"             | '000001'  | '2,145,000'       | '5/2/2024'      | "Yes"             | '2000005' | '2,145,000'    | '5/2/2024'      | "Yes"             | '2000005' | '0'     | ''                | "No"            | ''        |
			| "2C:Corporation "                                                  | '2,050,000'      | '2/1/2024'      | "Yes"             | '000002'  | '2,255,000'       | ''                | "No"            | ''        | '2,255,000'    | ''                | "No"            | ''        | '0'     | ''                | "No"            | ''        |
			| "4C:Enterprise 8.3 CORP. Server License (x86-64) "           | '180,000'        | '3/1/2024'      | "Yes"             | '000003'  | '198,000'         | ''                | "No"            | ''        | '198,000'      | ''                | "No"            | ''        | '0'     | ''                | "No"            | ''        |
			| "1C:ERP. Corporate performance management "                                   | '1,950,000'      | '4/1/2024'      | "Yes"             | '000004'  | '660,000'         | '1/2/2024'      | "Yes"             | '2000001' | '660,000'      | '1/2/2024'      | "Yes"             | '2000001' | '0'     | ''                | "No"            | ''        |
			| "3C:Enterprise 8 CORP. Client license for 100 users " | '600,000'        | '5/1/2024'      | "Yes"             | '000005'  | '1,375,000'       | ''                | "No"            | ''        | '1,375,000'    | ''                | "No"            | ''        | '0'     | ''                | "No"            | ''        |
...
Сценарий: 07.08 Интерактивное удаление показателей
	...
	* Сверяем результат
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| ''                                                                | "January 2024" | ''                | ''               | ''        | "February 2024" | ''                | ''               | ''        | "March 2024" | ''                | ''               | ''        | "TOTAL" | ''                | ''               | ''        |
			| ''                                                                | "Price"           | "DateReceipts" | "IncludeInPrice" | "Product ID" | "Price"            | "DateReceipts" | "IncludeInPrice" | "Product ID" | "Price"         | "DateReceipts" | "IncludeInPrice" | "Product ID" | "Price"  | "DateReceipts" | "IncludeInPrice" | "Product ID" |
			| "Goods"                                                          | '1,206,000'      | '1/1/2024'      | "No"            | ''        | '1,326,600'       | ''                | "No"            | ''        | '1,326,600'    | ''                | "No"            | ''        | '0'     | ''                | "No"            | ''        |
			| "5C:Corporate performance management "                                      | '1,250,000'      | '1/1/2024'      | "Yes"             | '000001'  | '2,145,000'       | '5/2/2024'      | "Yes"             | '2000005' | '2,145,000'    | '5/2/2024'      | "Yes"             | '2000005' | '0'     | ''                | "No"            | ''        |
			| "2C:Corporation "                                                  | '2,050,000'      | '2/1/2024'      | "Yes"             | '000002'  | '2,255,000'       | ''                | "No"            | ''        | '2,255,000'    | ''                | "No"            | ''        | '0'     | ''                | "No"            | ''        |
			| "4C:Enterprise 8.3 CORP. Server License (x86-64) "           | '180,000'        | '3/1/2024'      | "Yes"             | '000003'  | '198,000'         | ''                | "No"            | ''        | '198,000'      | ''                | "No"            | ''        | '0'     | ''                | "No"            | ''        |
			| "1C:ERP. Corporate performance management "                                   | '1,950,000'      | '4/1/2024'      | "Yes"             | '000004'  | '660,000'         | '1/2/2024'      | "Yes"             | '2000001' | '660,000'      | '1/2/2024'      | "Yes"             | '2000001' | '0'     | ''                | "No"            | ''        |
	...
	* Сверяем результат
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| "5C:Corporate performance management "            | '0'              | ''                | "No"            | ' '       | '2,145,000'       | '5/2/2024'      | "Yes"             | '2000005' | '2,145,000'    | '5/2/2024'      | "Yes"             | '2000005' | '0'     | ''                | "No"            | ''        |
			| "2C:Corporation "                        | '0'              | ''                | "No"            | ''        | '2,255,000'       | ''                | "No"            | ''        | '2,255,000'    | ''                | "No"            | ''        | '0'     | ''                | "No"            | ''        |
			| "1C:ERP. Corporate performance management "         | '1,950,000'      | ''                | "Yes"             | '000004'  | '660,000'         | '1/2/2024'      | "Yes"             | '2000001' | '660,000'      | '1/2/2024'      | "Yes"             | '2000001' | '0'     | ''                | "No"            | ''        |
...
Сценарий: 07.10 Расчет с удалением показателей
	...
	* Проверяем форму
		...
		И элемент формы с именем 'ReportEndPeriod' стал равен "March 2024"
		И элемент формы с именем 'ReportPeriodFrom' стал равен "January 2024"
	...
	* Проверяем движения
		...
		И я жду когда в табличном документе 'ReportSpreadsheetDocument' заполнится ячейка 'R2C1' в течение 30 секунд
		Дано Табличный документ 'ReportSpreadsheetDocument' равен макету "Макеты\07\ВА_НечисловыеПоказателиПриемник_Венера_Движения.mxl" по шаблону
...
Сценарий: 07.11 Создание экземпляра отчета - "VA - Calculation in code" 
	...
	* Рассчитываем документ и сверяем результат
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| "5C:Corporate performance management "                                      | '1,250,000'      | '1/1/2024' | "Yes"     | '000001'                                                           | '2,145,000'       | '5/2/2024' | "Yes"     | '2000005'                                                           | '2,145,000'    | '5/2/2024' | "Yes"     | '2000005'                                                        | '5,540,000'  | ''     | "No"    | ''       |
			| "2C:Corporation "                                                  | '2,050,000'      | '2/1/2024' | "Yes"     | '000002'                                                           | '2,255,000'       | ''           | "No"    | ''                                                                  | '2,255,000'    | ''           | "No"    | ''                                                               | '6,560,000'  | ''     | "No"    | ''       |
			| "4C:Enterprise 8.3 CORP. Server License (x86-64) "           | '180,000'        | '3/1/2024' | "Yes"     | '000003'                                                           | '198,000'         | ''           | "No"    | ''                                                                  | '198,000'      | ''           | "No"    | ''                                                               | '576,000'    | ''     | "No"    | ''       |
			| "1C:ERP. Corporate performance management "                                   | '1,950,000'      | '4/1/2024' | "Yes"     | '000004'                                                           | '660,000'         | '1/2/2024' | "Yes"     | '2000001'                                                           | '660,000'      | '1/2/2024' | "Yes"     | '2000001'                                                        | '3,270,000'  | ''     | "No"    | ''       |
			| "3C:Enterprise 8 CORP. Client license for 100 users " | '600,000'        | '5/1/2024' | "Yes"     | '000005'                                                           | '1,375,000'       | ''           | "No"    | ''                                                                  | '1,375,000'    | ''           | "No"    | ''                                                               | '3,350,000'  | ''     | "No"    | ''       |
			...
			| "5C:Corporate performance management "                                      | '1,250,000'      | '2/1/2024' | "No"    | '!!! 000001'                                                       | '4,290,000'       | '6/2/2024' | "No"    | '!!! 2000005'                                                       | '6,435,000'    | '6/2/2024' | "No"    | '!!! 2000005'                                                    | '11,975,000' | ''     | "No"    | ''       |
			| "2C:Corporation "                                                  | '2,050,000'      | '3/1/2024' | "No"    | '!!! 000002'                                                       | '4,510,000'       | ''           | "Yes"     | ''                                                                  | '6,765,000'    | ''           | "No"    | ''                                                               | '13,325,000' | ''     | "No"    | ''       |
			| "4C:Enterprise 8.3 CORP. Server License (x86-64) "           | '180,000'        | '4/1/2024' | "No"    | '!!! 000003'                                                       | '396,000'         | ''           | "No"    | ''                                                                  | '594,000'      | ''           | "No"    | ''                                                               | '1,170,000'  | ''     | "No"    | ''       |
			| "1C:ERP. Corporate performance management "                                   | '1,950,000'      | '5/1/2024' | "No"    | '!!! 000004'                                                       | '1,320,000'       | '2/2/2024' | "No"    | '!!! 2000001'                                                       | '1,980,000'    | '2/2/2024' | "No"    | '!!! 2000001'                                                    | '5,250,000'  | ''     | "No"    | ''       |
			| "3C:Enterprise 8 CORP. Client license for 100 users " | '600,000'        | '6/1/2024' | "No"    | '!!! 000005'                                                       | '2,750,000'       | ''           | "No"    | ''                                                                  | '4,125,000'    | ''           | "No"    | ''                                                               | '7,475,000'  | ''     | "No"    | ''       |
