...
Сценарий: 07.02 Создание вида отчета 'VA - Non-Numbers (source)'
	...
	И Я в конструкторе отчета добавляю колонку с именем 'ProductID'	
	...
	И Я Для вида отчета 'VA - Non-Numbers (source)' в бланке для группы раскрытия с адресом 'R8C1' задаю сортировку 'Products.Product ID'
...
Сценарий: 07.03 Создание экземпляра отчета - 'VA - Non-Numbers (source)' 
	...
	* Документ должен быть пустой
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| ''                                      | 'Price'           | 'DateReceipts' | 'IncludeInPrice' | 'ProductID' | 'Price'            | 'DateReceipts' | 'IncludeInPrice' | 'ProductID' | 'Price'         | 'DateReceipts' | 'IncludeInPrice' | 'ProductID' | 'Price'  | 'DateReceipts' | 'IncludeInPrice' | 'ProductID' |
	...
	* Вводим значения показателей
		* Ввод цены
			И Я добавляю значения с раскрытием показателей в ячейку 'R6C2'
				| 'VA0Product'                                                     | 'Value'        |
				| '1C:Enterprise 8.3 CORP. Server License (x86-64)'           | '180,000.00000'   |
				| '1C:Enterprise 8 CORP. Client license for 100 users' | '600,000.00000'   |
				| '1C:Corporate performance management'                                      | '1,250,000.00000' |
				| '1C:Corporation'                                                  | '2,050,000.00000' |
		...
		* Ввод даты поступления в форме
			И Я добавляю значения с раскрытием показателей в ячейку 'R6C7'
				| 'VA0Product'                   | 'Value'   |
				| '1C:Corporate performance management'    | '5/2/2021' |
		...
		* Ввод флага включение в прайс в форме
			И Я добавляю значения с раскрытием показателей в ячейку 'R6C8'
				| 'VA0Product'                   | 'Value' |
				| '1C:Corporate performance management'    | "Yes"       |
		...
		* Ввод артикула в форме
			И Я добавляю значения с раскрытием показателей в ячейку 'R6C9'
				...
				| '1C:Corporate performance management'    | '2000005'  |			
	...
	* Сравниваем итоговый документ
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| '1C:Corporate performance management '                                      | '1,250,000'      | '1/1/2021'      | 'Yes'             | '000001'  | '2,145,000'       | '5/2/2021'      | 'Yes'             | '2000005' | '2,145,000'    | '5/2/2021'      | 'Yes'             | '2000005' | '0'     | '1/1/2021'      | 'No'            | ''        |
			| '1C:Corporation '                                                  | '2,050,000'      | '2/1/2021'      | 'Yes'             | '000002'  | '2,255,000'       | ''                | 'No'            | ''        | '2,255,000'    | ''                | 'No'            | ''        | '0'     | '2/1/2021'      | 'No'            | ''        |
			| '1C:Enterprise 8.3 CORP. Server License (x86-64) '           | '180,000'        | '3/1/2021'      | 'Yes'             | '000003'  | '198,000'         | ''                | 'No'            | ''        | '198,000'      | ''                | 'No'            | ''        | '0'     | '3/1/2021'      | 'No'            | ''        |
			...
			| '1C:Enterprise 8 CORP. Client license for 100 users ' | '600,000'        | '5/1/2021'      | 'Yes'             | '000005'  | '1,375,000'       | ''                | 'No'            | ''        | '1,375,000'    | ''                | 'No'            | ''        | '0'     | '5/1/2021'      | 'No'            | ''        |
...
Сценарий: 07.04 Создание вида отчета 'VA - Non-Numbers (recipient)'
	...
	И Я в конструкторе отчета добавляю строку с именем 'Goods'
	И Я в конструкторе отчета добавляю строку с именем 'Formulae'
	...
	* Устанавливаем формулы расчета
		...
		* Формулы
			* Цена
				* Добавляем источники
					...
					И я нажимаю на кнопку с именем 'FormCreate'
					Тогда открылось окно "Data source (create)"
					И из выпадающего списка с именем 'ReportTypeFilter' я выбираю по строке 'VA - нечисловые показатели (source)'
					И я нажимаю кнопку выбора у поля с именем 'IndicatorFilter'
				...
				* Вводим формулу
					Когда открылось окно "Edit tree"
					И в поле с именем 'TextDocFieldProcedure' я ввожу текст ' ?([VANonNumbersSource_Goods_IncludeInPrice01],[VANonNumbersSource_Goods_Price01],-1) '
					И я нажимаю на кнопку с именем 'WriteAndCollapse'
			* ДатаПоступления
				* Добавляем источники
					Когда открылось окно "Edit tree"
				...
				* Вводим формулу
					Тогда открылось окно "Edit tree *"
					И в поле с именем 'TextDocFieldProcedure' я ввожу текст '[VANonNumbersSource_Goods_DateReceipts01] + 86400'
					И я нажимаю на кнопку с именем 'WriteAndCollapse'
			* ВключатьВПрайс
				* Добавляем источники
					Когда открылось окно "Edit tree"
				...
				* Вводим формулу
					...
					И в поле с именем 'TextDocFieldProcedure' я ввожу текст 'Result = NOT [VANonNumbersSource_Goods_IncludeInPrice02]'
					И я нажимаю на кнопку с именем 'WriteAndCollapse'
			* Артикул
				* Добавляем источники
					Когда открылось окно "Edit tree"
				...
				* Вводим формулу
					...
					И в поле с именем 'TextDocFieldProcedure' я ввожу текст 
						|'tRow = [VANonNumbersSource_Goods_ProductID01];'|
						|'Result = "";'|
						|'For Cnt = 1 To StrLen(tRow) Do'|
						|' Result = Сред(tRow, Cnt, 1) + Result;'|
						|'EndDo; '|
					И я нажимаю на кнопку с именем 'WriteAndCollapse'	
		* Источник
			* Цена
			...
			* ВключатьВПрайс
				...
				И в поле с именем 'Pattern' я ввожу текст '1C:Corporate performance management'
			...
			* Артикул
				...
				И из выпадающего списка с именем 'DBObjects' я выбираю по строке 'Products'
				Если '$$IsCPM$$' Тогда
	...
	И Я Для вида отчета 'VA - Non-Numbers (recipient)' в бланке для группы раскрытия с адресом 'R8C1' задаю сортировку 'Products.Product ID'
	И Я Для вида отчета 'VA - Non-Numbers (recipient)' в бланке для группы раскрытия с адресом 'R10C1' задаю сортировку 'Products.Product ID'
	И Я Для вида отчета 'VA - Non-Numbers (recipient)' в бланке для группы раскрытия с адресом 'R12C1' задаю сортировку 'Products.Product ID'
...
Сценарий: 07.05 Создание экземпляра отчета - 'VA - Non-Numbers (recipient)'  
	...
	* Рассчитываем документ и сравниваем итоговый документ
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| '1C:Corporate performance management '                                      | '1,250,000'      | '1/1/2021'      | 'Yes'             | '000001'        | '2,145,000'       | '5/2/2021'      | 'Yes'             | '2000005'       | '2,145,000'    | '5/2/2021'      | 'Yes'             | '2000005'       | '5,540,000'  | '5/2/2021'      | 'Yes'             | ''        |
			| '1C:Corporation '                                                  | '2,050,000'      | '2/1/2021'      | 'Yes'             | '000002'        | '2,255,000'       | ''                | 'No'            | ''              | '2,255,000'    | ''                | 'No'            | ''              | '6,560,000'  | '2/1/2021'      | 'Yes'             | ''        |
			| '1C:Enterprise 8.3 CORP. Server License (x86-64) '           | '180,000'        | '3/1/2021'      | 'Yes'             | '000003'        | '198,000'         | ''                | 'No'            | ''              | '198,000'      | ''                | 'No'            | ''              | '576,000'    | '3/1/2021'      | 'Yes'             | ''        |
			...
			| '1C:Enterprise 8 CORP. Client license for 100 users ' | '600,000'        | '5/1/2021'      | 'Yes'             | '000005'        | '1,375,000'       | ''                | 'No'            | ''              | '1,375,000'    | ''                | 'No'            | ''              | '3,350,000'  | '5/1/2021'      | 'Yes'             | ''        |
			| 'Formulae'                                                         | '6,030,000'      | '5/2/2021'      | 'No'            | ''              | '2,804,997'       | '5/3/2021'      | 'Yes'             | ''              | '2,804,997'    | '5/3/2021'      | 'No'            | ''              | '11,639,994' | '5/3/2021'      | 'Yes'             | ''        |
			| '1C:Corporate performance management '                                      | '1,250,000'      | '1/2/2021'      | 'No'            | '100000'        | '2,145,000'       | '5/3/2021'      | 'No'            | '5000002'       | '2,145,000'    | '5/3/2021'      | 'No'            | '5000002'       | '5,540,000'  | '5/3/2021'      | 'No'            | ''        |
			| '1C:Corporation '                                                  | '2,050,000'      | '2/2/2021'      | 'No'            | '200000'        | '-1'              | ''                | 'Yes'             | ''              | '-1'           | ''                | 'No'            | ''              | '2,049,998'  | '2/2/2021'      | 'Yes'             | ''        |
			| '1C:Enterprise 8.3 CORP. Server License (x86-64) '           | '180,000'        | '3/2/2021'      | 'No'            | '300000'        | '-1'              | ''                | 'No'            | ''              | '-1'           | ''                | 'No'            | ''              | '179,998'    | '3/2/2021'      | 'No'            | ''        |
			...
			| '1C:Enterprise 8 CORP. Client license for 100 users ' | '600,000'        | '5/2/2021'      | 'No'            | '500000'        | '-1'              | ''                | 'No'            | ''              | '-1'           | ''                | 'No'            | ''              | '599,998'    | '5/2/2021'      | 'No'            | ''        |
			| 'Source'                                                        | '6,030,000'      | '1/4/2021'      | 'Yes'             | ''              | '6,633,000'       | '2/4/2021'      | 'Yes'             | ''              | '7,495,400'    | '3/4/2021'      | 'Yes'             | ''              | '20,158,400' | '3/4/2021'      | 'Yes'             | ''        |
			| '1C:Corporate performance management '                                      | '1,250,000'      | '1/4/2021'      | 'Yes'             | '2900001871389' | '1,375,000'       | '2/4/2021'      | 'Yes'             | '2900001871389' | '1,553,800'    | '3/4/2021'      | 'Yes'             | '2900001871389' | '4,178,800'  | '3/4/2021'      | 'Yes'             | ''        |
			| '1C:Corporation '                                                  | '2,050,000'      | '1/4/2021'      | 'No'            | '2900001871419' | '2,255,000'       | '2/4/2021'      | 'No'            | '2900001871419' | '2,548,200'    | '3/4/2021'      | 'No'            | '2900001871419' | '6,853,200'  | '3/4/2021'      | 'No'            | ''        |
			| '1C:Enterprise 8.3 CORP. Server License (x86-64) '           | '180,000'        | '1/4/2021'      | 'No'            | '2900001916059' | '198,000'         | '2/4/2021'      | 'No'            | '2900001916059' | '223,700'      | '3/4/2021'      | 'No'            | '2900001916059' | '601,700'    | '3/4/2021'      | 'No'            | ''        |
			...
			| '1C:Enterprise 8 CORP. Client license for 100 users ' | '600,000'        | '1/4/2021'      | 'No'            | '4601546106674' | '660,000'         | '2/4/2021'      | 'No'            | '4601546106674' | '745,800'      | '3/4/2021'      | 'No'            | '4601546106674' | '2,005,800'  | '3/4/2021'      | 'No'            | ''        |
...
Сценарий: 07.06 Создание вида отчета 'VA - Calculation in code'
	...
	И Я в конструкторе отчета добавляю строку с именем 'ReceiverCode'
	И Я в конструкторе отчета добавляю строку с именем 'FormulaeCode'
	...
	* Устанавливаем формулы расчета
		...
		* ИсточникКод
			* Число
				...
				Тогда открылось окно 'VA - Calculation in code, : EvalFormula'
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 
					|'IndicatorsArray = New Array;'|
					|'IndicatorsArray.Add("VANonNumbersSource:Goods_Price");'|
					|'AdditionalParameters = New Structure("GrandTotal",Enums.IndicatorTotalsTypes.Sum);'|
					|'tIndicatorsValues = GetIndicatorsValue(New Structure("ReportsIndicators,Currency,ReportPeriod",IndicatorsArray,SettlementObject.MainCurrency,SettlementObject.ReportPeriod),,AdditionalParameters);'|
					|''|
			...
			* Дата
				...
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 
					|'IndicatorsArray = New Array;'|
					|'IndicatorsArray.Add("VANonNumbersSource:Goods_DateReceipts");'|
					|'tIndicatorsValues = GetIndicatorsValue(New Structure("ReportsIndicators,Currency,ReportPeriod",IndicatorsArray,SettlementObject.MainCurrency,SettlementObject.ReportPeriod));'|
					|''|
					|'If tIndicatorsValues.Count() = 0 Then'|
					|' Result = Undefined;'|
					|'Else'|
			...
			* Булево
				...
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст
					|'IndicatorsArray = New Array;'|
					|'IndicatorsArray.Add("VANonNumbersSource:Goods_IncludeInPrice");'|
					|'tIndicatorsValues = GetIndicatorsValue(New Structure("ReportsIndicators,Currency,ReportPeriod",IndicatorsArray,SettlementObject.MainCurrency,SettlementObject.ReportPeriod));'|
					|''|
					|'If tIndicatorsValues.Count() = 0 Then'|
					|' Result = Undefined;'|
			...
			* Строка
				...
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 
					|'IndicatorsArray = New Array;'|
					|'IndicatorsArray.Add("VANonNumbersSource:Goods_ProductID");'|
					|'tIndicatorsValues = GetIndicatorsValue(New Structure("ReportsIndicators,Currency,ReportPeriod",IndicatorsArray,SettlementObject.MainCurrency,SettlementObject.ReportPeriod));'|
					|''|
					|'If tIndicatorsValues.Count() = 0 Then'|
					|' Result = Undefined;'|
		...
		* ПриемникКод
			* Число
				...
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст
					|'IndicatorsArray = New Array;'|
					|'IndicatorsArray.Add("VACalculationInCode:Source_Number");'|
					|'AdditionalParameters = New Structure("GrandTotal",Enums.IndicatorTotalsTypes.Sum);'|
					|'tIndicatorsValues = GetIndicatorsValue(New Structure("ReportsIndicators,Currency,ReportPeriod",IndicatorsArray,SettlementObject.MainCurrency,SettlementObject.ReportPeriod),,AdditionalParameters);'|
					|''|
					|'If tIndicatorsValues.Count() = 0 Then'|
			...
			* Дата
				...
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст
					|'IndicatorsArray = New Array;'|
					|'IndicatorsArray.Add("VACalculationInCode:Source_Date");'|
					|'tIndicatorsValues = GetIndicatorsValue(New Structure("ReportsIndicators,Currency,ReportPeriod",IndicatorsArray,SettlementObject.MainCurrency,SettlementObject.ReportPeriod));'|
					|''|
					|'If tIndicatorsValues.Count() = 0 Then'|
					|' Result = Undefined;'|
			...
			* Булево
				...
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 
					|'IndicatorsArray = New Array;'|
					|'IndicatorsArray.Add("VACalculationInCode:Source_Boolean");'|
					|'tIndicatorsValues = GetIndicatorsValue(New Structure("ReportsIndicators,Currency,ReportPeriod",IndicatorsArray,SettlementObject.MainCurrency,SettlementObject.ReportPeriod));'|
					|''|
					|'If tIndicatorsValues.Count() = 0 Then'|
					|' Result = Undefined;'|
			...
			* Строка
				...
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 
					|'IndicatorsArray = New Array;'|
					|'IndicatorsArray.Add("VACalculationInCode:Source_Row");'|
					|'tIndicatorsValues = GetIndicatorsValue(New Structure("ReportsIndicators,Currency,ReportPeriod",IndicatorsArray,SettlementObject.MainCurrency,SettlementObject.ReportPeriod));'|
					|''|
					|'If tIndicatorsValues.Count() = 0 Then'|
					|' Result = Undefined;'|
		...
		* ФормулыКод
			* Число
				...
				И в табличном документе 'SpreadsheetFieldTemlate' я делаю двойной клик на текущей ячейке
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 'Result = Month(SettlementObject.ReportPeriod.StartDate);'
				И я нажимаю на кнопку с именем 'ArbitraryCode'
				И я нажимаю на кнопку с именем 'WriteAndCollapse'
			* Дата
				Когда открылось окно "Edit tree"
				...
				И в табличном документе 'SpreadsheetFieldTemlate' я делаю двойной клик на текущей ячейке
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 'Result = RelativePeriod(SettlementObject.ReportPeriod, -1).StartDate;'
				И я нажимаю на кнопку с именем 'ArbitraryCode'
				И я нажимаю на кнопку с именем 'WriteAndCollapse'
			* Булево
				Когда открылось окно "Edit tree"
				...
				И в табличном документе 'SpreadsheetFieldTemlate' я делаю двойной клик на текущей ячейке
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 'Result = DateBelongsToPeriod(SettlementObject.ReportPeriod.StartDate, SettlementObject.PeriodsArray.Get(0));'
				И я нажимаю на кнопку с именем 'ArbitraryCode'
				И я нажимаю на кнопку с именем 'WriteAndCollapse'
			* Строка
				Когда открылось окно "Edit tree"
				...
				И в табличном документе 'SpreadsheetFieldTemlate' я делаю двойной клик на текущей ячейке
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 
					|'Result = String(SettlementObject.Company) + Chars.LF +'|
		...
		* Расчет
			* Число
				...
				И из выпадающего списка с именем 'ReportTypeFilter' я выбираю по строке 'VA - Calculation in code'
				И я нажимаю кнопку выбора у поля с именем 'IndicatorFilter'
				И Я выбираю показатель с кодом 'FormulaeCode_Number'
				Тогда открылось окно "Data source (create) *"
			...
			* Дата
				...
				Тогда открылось окно "Edit tree"
				И я нажимаю на кнопку с именем 'ArbitraryCode'
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 'Result = AddMonth([VACalculationInCode_Source_Date],1) '
				И я нажимаю на кнопку с именем 'WriteAndCollapse'
			* Булево
				Когда открылось окно "Edit tree"
				...
				И я нажимаю на кнопку с именем 'WriteFormula'
				Тогда открылось окно "Edit tree"
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст 'NOT [VACalculationInCode_Source_Boolean]'
				И я нажимаю на кнопку с именем 'WriteAndCollapse'
			* Строка
				Когда открылось окно "Edit tree"
				...
				И я нажимаю на кнопку с именем 'WriteFormula'
				Тогда открылось окно "Edit tree"
				И в поле с именем 'TextDocFieldProcedure' я ввожу текст '"!!! " + [VACalculationInCode_Source_ROW]'
				И я нажимаю на кнопку с именем 'WriteAndCollapse'

	И Я Для вида отчета 'VA - Calculation in code' я создаю бланк по умолчанию
	И Я Для вида отчета 'VA - Calculation in code' в бланке для группы раскрытия с адресом 'R8C1' задаю сортировку 'Products.Product ID'
	И Я Для вида отчета 'VA - Calculation in code' в бланке для группы раскрытия с адресом 'R13C1' задаю сортировку 'Products.Product ID'
...
Сценарий: 07.07 Создание экземпляра отчета - 'VA - Calculation in code' 
	...
	* Рассчитываем документ и сверяем результат
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| ''                                                                | ''               | ''           | ''       | ''                                                                 | ''                | ''           | ''       | ''                                                                  | ''             | ''           | ''       | ''                                                               | ''           | ''           | ''       | ''       |
			| ''                                                                | 'January 2021' | ''           | ''       | ''                                                                 | 'February 2021' | ''           | ''       | ''                                                                  | 'March 2021' | ''           | ''       | ''                                                               | 'TOTAL'      | ''           | ''       | ''       |
			| ''                                                                | 'Number'          | 'Date'       | 'Boolean' | 'String'                                                           | 'Number'           | 'Date'       | 'Boolean' | 'String'                                                            | 'Number'        | 'Date'       | 'Boolean' | 'String'                                                         | 'Number'      | 'Date'       | 'Boolean' | 'String' |
			...
			| 'ReceiverCode'                                                     | '0'              | ''           | 'No'    | ''                                                                 | '0'               | ''           | 'No'    | ''                                                                  | '0'            | ''           | 'No'    | ''                                                               | '0'          | ''           | 'No'    | ''       |
			| 'FormulaeCode'                                                      | '1'              | '12/1/2020' | 'Yes'     | 'Mercury LLC\nVA - Main scenario\nRUB\nJanuary 2021\nMonth' | '2'               | '1/1/2021' | 'No'    | 'Mercury LLC\nVA - Main scenario\nRUB\nFebruary 2021\nMonth' | '3'            | '2/1/2021' | 'No'    | 'Mercury LLC\nVA - Main scenario\nRUB\nMarch 2021\nMonth' | '6'          | '2/1/2021' | 'Yes'     | ''       |
			| 'Calculation'                                                          | '6,030,000'      | '6/1/2021' | 'No'    | ''                                                                 | '13,266,000'      | '6/2/2021' | 'Yes'     | ''                                                                  | '19,899,000'   | '6/2/2021' | 'No'    | ''                                                               | '39,195,000' | '6/2/2021' | 'Yes'     | ''       |
			| '1C:Corporate performance management '                                      | '1,250,000'      | '2/1/2021' | 'No'    | '!!! 000001'                                                       | '4,290,000'       | '6/2/2021' | 'No'    | '!!! 2000005'                                                       | '6,435,000'    | '6/2/2021' | 'No'    | '!!! 2000005'                                                    | '11,975,000' | '6/2/2021' | 'No'    | ''       |
			| '1C:Corporation '                                                  | '2,050,000'      | '3/1/2021' | 'No'    | '!!! 000002'                                                       | '4,510,000'       | ''           | 'Yes'     | ''                                                                  | '6,765,000'    | ''           | 'No'    | ''                                                               | '13,325,000' | '3/1/2021' | 'Yes'     | ''       |
			| '1C:Enterprise 8.3 CORP. Server License (x86-64) '           | '180,000'        | '4/1/2021' | 'No'    | '!!! 000003'                                                       | '396,000'         | ''           | 'No'    | ''                                                                  | '594,000'      | ''           | 'No'    | ''                                                               | '1,170,000'  | '4/1/2021' | 'No'    | ''       |
			...
			| '1C:Enterprise 8 CORP. Client license for 100 users ' | '600,000'        | '6/1/2021' | 'No'    | '!!! 000005'                                                       | '2,750,000'       | ''           | 'No'    | ''                                                                  | '4,125,000'    | ''           | 'No'    | ''                                                               | '7,475,000'  | '6/1/2021' | 'No'    | ''       |
	...
	* Рассчитываем документ еще раз и сверяем изменившийся результат
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| '1C:Enterprise 8 CORP. Client license for 100 users ' | '600,000'        | '5/1/2021' | 'Yes'     | '000005'                                                           | '1,375,000'       | ''           | 'No'    | ''                                                                  | '1,375,000'    | ''           | 'No'    | ''                                                               | '3,350,000'  | '5/1/2021' | 'Yes'     | ''       |
			| 'SourceCode'                                                     | '6,030,000'      | '5/1/2021' | 'Yes'     | '000005'                                                           | '6,633,000'       | '5/2/2021' | 'Yes'     | '2000005'                                                           | '6,633,000'    | '5/2/2021' | 'Yes'     | '2000005'                                                        | '19,296,000' | '5/2/2021' | 'Yes'     | ''       |
			| 'ReceiverCode'                                                     | '6,030,000'      | '5/1/2021' | 'Yes'     | '000005'                                                           | '6,633,000'       | '5/2/2021' | 'Yes'     | '2000005'                                                           | '6,633,000'    | '5/2/2021' | 'Yes'     | '2000005'                                                        | '19,296,000' | '5/2/2021' | 'Yes'     | ''       |
			| 'FormulaeCode'                                                      | '1'              | '12/1/2020' | 'Yes'     | 'Mercury LLC\nVA - Main scenario\nRUB\nJanuary 2021\nMonth' | '2'               | '1/1/2021' | 'No'    | 'Mercury LLC\nVA - Main scenario\nRUB\nFebruary 2021\nMonth' | '3'            | '2/1/2021' | 'No'    | 'Mercury LLC\nVA - Main scenario\nRUB\nMarch 2021\nMonth' | '6'          | '2/1/2021' | 'Yes'     | ''       |
			| 'Calculation'                                                          | '6,030,000'      | '6/1/2021' | 'No'    | ''                                                                 | '13,266,000'      | '6/2/2021' | 'Yes'     | ''                                                                  | '19,899,000'   | '6/2/2021' | 'No'    | ''                                                               | '39,195,000' | '6/2/2021' | 'Yes'     | ''       |
			| '1C:Corporate performance management '                                      | '1,250,000'      | '2/1/2021' | 'No'    | '!!! 000001'                                                       | '4,290,000'       | '6/2/2021' | 'No'    | '!!! 2000005'                                                       | '6,435,000'    | '6/2/2021' | 'No'    | '!!! 2000005'                                                    | '11,975,000' | '6/2/2021' | 'No'    | ''       |
			| '1C:Corporation '                                                  | '2,050,000'      | '3/1/2021' | 'No'    | '!!! 000002'                                                       | '4,510,000'       | ''           | 'Yes'     | ''                                                                  | '6,765,000'    | ''           | 'No'    | ''                                                               | '13,325,000' | '3/1/2021' | 'Yes'     | ''       |
	...
	* Записываем документ и сверяем движения	
		...
		Дано Табличный документ 'ReportSpreadsheetDocument' равен макету 'Макеты\ВА_РасчетВКоде_Движения_En_En.mxl' по шаблону
...
Сценарий: 07.08 Создание вида отчета 'VA - Grouping by analytics'
	...
	И Я в конструкторе отчета добавляю колонку с именем 'Mean'
	...
	* Устанавливаем формулы расчета для группы
		...
		* Максимум
			...
			И в табличном документе 'SpreadsheetFieldTemlate' я делаю двойной клик на текущей ячейке
			И я нажимаю на кнопку с именем 'ArbitraryCode'
			И в поле с именем 'TextDocFieldProcedure' я ввожу текст 'Result = Max([VAGroupingByAnalytics_GoodsSum_Maximum], [VAGroupingByAnalytics_GoodsNoTotal_Maximum]) '
			И я нажимаю на кнопку с именем 'WriteAndCollapse'
		* Минимум
			Когда открылось окно "Edit tree"
			И в табличном документе 'SpreadsheetFieldTemlate' я перехожу к ячейке 'R2C4'
			И в табличном документе 'SpreadsheetFieldTemlate' я делаю двойной клик на текущей ячейке
			И в поле с именем 'TextDocFieldProcedure' я ввожу текст '?({VAGroupingByAnalytics.GoodsSum_Minimum}<{VAGroupingByAnalytics.GoodsNoTotal_Minimum},{VAGroupingByAnalytics.GoodsSum_Minimum},{VAGroupingByAnalytics.GoodsNoTotal_Minimum}) '
			И я нажимаю на кнопку с именем 'WriteAndCollapse'
		* Среднее
			Когда открылось окно "Edit tree"
			И в табличном документе 'SpreadsheetFieldTemlate' я перехожу к ячейке 'R2C5'
			И в табличном документе 'SpreadsheetFieldTemlate' я делаю двойной клик на текущей ячейке
			И в поле с именем 'TextDocFieldProcedure' я ввожу текст '({VAGroupingByAnalytics.GoodsSum_Mean} + {VAGroupingByAnalytics.GoodsNoTotal_Mean})  /  2'
			И я нажимаю на кнопку с именем 'WriteAndCollapse'						
		* БезИтога
			Когда открылось окно "Edit tree"
			...
			* Должна сработать проверка деления на 0
				...
				И я нажимаю на кнопку с именем 'Button0'
			Тогда открылось окно "Edit tree *"
			И в поле с именем 'TextDocFieldProcedure' я ввожу текст '?({VAGroupingByAnalytics.GoodsNoTotal_NoTotal}=0,-1,{VAGroupingByAnalytics.GoodsSum_NoTotal} / {VAGroupingByAnalytics.GoodsNoTotal_NoTotal}) '
			И я нажимаю на кнопку с именем 'WriteAndCollapse'
			Когда открылось окно "Edit tree"
			И Я закрываю окно "Edit tree"							
									
	И Я Для вида отчета 'VA - Grouping by analytics' я создаю бланк по умолчанию
	И Я Для вида отчета 'VA - Grouping by analytics' в бланке для группы раскрытия с адресом 'R9C1' задаю сортировку 'Products.Product ID'
...
Сценарий: 07.09 Создание экземпляра отчета - 'VA - Grouping by analytics'
	...
	* Сравниваем результат
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| ''                                                                | ''               | ''          | ''          | ''          | ''          | ''                | ''          | ''          | ''          | ''          | ''             | ''          | ''          | ''          | ''          | ''           | ''          | ''          | ''           | ''         |
			| ''                                                                | 'January 2021' | ''          | ''          | ''          | ''          | 'February 2021' | ''          | ''          | ''          | ''          | 'March 2021' | ''          | ''          | ''          | ''          | 'TOTAL'      | ''          | ''          | ''           | ''         |
			| ''                                                                | 'Sum'          | 'Maximum'  | 'Minimum'   | 'Mean'   | 'NoTotal'  | 'Sum'           | 'Maximum'  | 'Minimum'   | 'Mean'   | 'NoTotal'  | 'Sum'        | 'Maximum'  | 'Minimum'   | 'Mean'   | 'NoTotal'  | 'Sum'      | 'Maximum'  | 'Minimum'   | 'Mean'    | 'NoTotal' |
			...
			| '1C:Corporate performance management '                                      | '1,250,000'      | '1,250,000' | '1,250,000' | '1,250,000' | '1,250,000' | '2,145,000'       | '2,145,000' | '2,145,000' | '2,145,000' | '2,145,000' | '2,145,000'    | '2,145,000' | '2,145,000' | '2,145,000' | '2,145,000' | '5,540,000'  | '2,145,000' | '1,250,000' | '1,846,667'  | '0'        |
			| '1C:Corporation '                                                  | '2,050,000'      | '2,050,000' | '2,050,000' | '2,050,000' | '2,050,000' | '2,255,000'       | '2,255,000' | '2,255,000' | '2,255,000' | '2,255,000' | '2,255,000'    | '2,255,000' | '2,255,000' | '2,255,000' | '2,255,000' | '6,560,000'  | '2,255,000' | '2,050,000' | '2,186,667'  | '0'        |
			| '1C:Enterprise 8.3 CORP. Server License (x86-64) '           | '180,000'        | '180,000'   | '180,000'   | '180,000'   | '180,000'   | '198,000'         | '198,000'   | '198,000'   | '198,000'   | '198,000'   | '198,000'      | '198,000'   | '198,000'   | '198,000'   | '198,000'   | '576,000'    | '198,000'   | '180,000'   | '192,000'    | '0'        |
			...
			| '1C:Enterprise 8 CORP. Client license for 100 users ' | '600,000'        | '600,000'   | '600,000'   | '600,000'   | '600,000'   | '1,375,000'       | '1,375,000' | '1,375,000' | '1,375,000' | '1,375,000' | '1,375,000'    | '1,375,000' | '1,375,000' | '1,375,000' | '1,375,000' | '3,350,000'  | '1,375,000' | '600,000'   | '1,116,667'  | '0'        |
	...
	* Проверяем движения	
		...
		Дано Табличный документ 'ReportSpreadsheetDocument' равен макету 'Макеты\ВА_ГруппировкаПоАналитикам_Движения_En_En.mxl' по шаблону
