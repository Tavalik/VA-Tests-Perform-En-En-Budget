...
Сценарий: 15.04 Создание экземпляра отчета "VA - Controlled indicators"
	...
	* Записываем, проверяем форму
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| "Dimensions"                         | '300'            | '200'        | '200'         | '1/1/2024' | '600'             | '400'        | '400'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '900'        | '600'        | '600'         | '2/1/2024' |
			| "3Software sale " | '300'            | '200'        | '200'         | '1/1/2024' | '600'             | '400'        | '400'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '900'        | '600'        | '600'         | '2/1/2024' |
			| "1C:ERP. Corporate performance management "     | '100'            | '0'          | '0'           | '1/1/2024' | '200'             | '0'          | '0'           | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '0'          | '0'           | '2/1/2024' |
			| 'RUB '                              | '100'            | '0'          | '0'           | '1/1/2024' | '200'             | '0'          | '0'           | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '0'          | '0'           | '2/1/2024' |
			| "2C:Corporation "                    | '100'            | '100'        | '100'         | '1/1/2024' | '200'             | '200'        | '200'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | '2/1/2024' |
			| 'RUB '                              | '100'            | '100'        | '100'         | '1/1/2024' | '200'             | '200'        | '200'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | '2/1/2024' |
			| "5C:Corporate performance management "        | '100'            | '100'        | '100'         | '1/1/2024' | '200'             | '200'        | '200'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | '2/1/2024' |
			| 'RUB '                              | '100'            | '100'        | '100'         | '1/1/2024' | '200'             | '200'        | '200'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | '2/1/2024' |
	...
	* Обновляем и проверяем форму
		...
		Тогда табличный документ 'SpreadsheetFieldTemlate' равен:
			...
			| ''                                  | "Quantity"     | "ControlYes" | "ControlNo" | "Date"       | "Quantity"      | "ControlYes" | "ControlNo" | "Date"       | "Quantity"   | "ControlYes" | "ControlNo" | "Date" | "Quantity" | "ControlYes" | "ControlNo" | "Date"       |
			| "Synthetic"                         | '100'            | '100'        | '100'         | '1/1/2024' | '200'             | '200'        | '200'         | '1/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | '1/1/2024' |
			| "Dimensions"                         | '200'            | '200'        | '200'         | '1/1/2024' | '400'             | '400'        | '400'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '600'        | '600'        | '600'         | '2/1/2024' |
			| "3Software sale " | '200'            | '200'        | '200'         | '1/1/2024' | '400'             | '400'        | '400'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '600'        | '600'        | '600'         | '2/1/2024' |
			| "2C:Corporation "                    | '100'            | '100'        | '100'         | '1/1/2024' | '200'             | '200'        | '200'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | '2/1/2024' |
			| 'RUB '                              | '100'            | '100'        | '100'         | '1/1/2024' | '200'             | '200'        | '200'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | '2/1/2024' |
			| "5C:Corporate performance management "        | '100'            | '100'        | '100'         | '1/1/2024' | '200'             | '200'        | '200'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | '2/1/2024' |
			| 'RUB '                              | '100'            | '100'        | '100'         | '1/1/2024' | '200'             | '200'        | '200'         | '2/1/2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | '2/1/2024' |
