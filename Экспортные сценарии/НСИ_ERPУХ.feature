...
Сценарий: Я создаю вид номенклатуры с именем '[CurNameВидаНоменклатуры]' тип '[CurType]' группа доступа '[CrntGroupДоступа]' в 1C:ERPУХ
	...
	* Создаем новый элемент
		...
		И я разворачиваю группу с именем 'ValuePageByDefault'
...
Сценарий: Для партнера '[CurNameПартнера]' я создаю контрагента с именем '[CurNameКонтрагента]' вид '[ТекKindКонтрагента]' в 1C:ERPУХ
	...
	* Создаем контрагента
		...
		И из выпадающего списка с именем 'KindКонтрагента' я выбираю точное значение '[ТекKindКонтрагента]'				
		И я нажимаю на кнопку с именем 'FormWriteAndClose'
...
Сценарий: Для партнера '[CurNameПартнера]' контрагента '[CurNameКонтрагента]' я создаю договор с видом '[ТекContractKind]' номер '[CrntNumber]' от '[CurDate]' организация '[CrntCompany]' валюта '[CrntCurrency]' сумма '[ТекSum]' соглашение '[ТекСоглашение]' в 1C:ERPУХ
	...
	* Создаем договор
		...
		И из выпадающего списка с именем 'Organization' я выбираю по строке '[CrntCompany]'
