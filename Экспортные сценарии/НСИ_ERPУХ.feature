...
Сценарий: Я создаю вид номенклатуры с именем '[CurNameВидаНоменклатуры]' тип '[CurType]' группа доступа '[CrntGroupДоступа]' в 1C:ERPУХ
	...
	* Создаем новый элемент
		...
		И у поля с именем 'ItemsType' я нажимаю гиперссылку 'указать'
		Тогда открылось окно "Выберите тип номенклатуры"
		И я меняю значение переключателя с именем 'ItemsTypeOwnGoods' на '[CurType]'
		И я нажимаю на кнопку с именем 'OK'
		Тогда открылось окно "Kind номенклатуры (create) *"
		И в поле с именем 'Parent' я ввожу текст ''
		И из выпадающего списка с именем 'AccessGroup' я выбираю точное значение '[CrntGroupДоступа]'
...
Сценарий: Я создаю партнера с именем '[CurNameПартнера]' тип '[CurType]' группа доступа '[CrntGroupДоступа]' в 1C:ERPУХ		
...
Сценарий: Для партнера '[CurNameПартнера]' контрагента '[CurNameКонтрагента]' я создаю договор с видом '[ТекContractKind]' номер '[CrntNumber]' от '[CurDate]' организация '[CrntCompany]' валюта '[CrntCurrency]' сумма '[ТекSum]' соглашение '[ТекСоглашение]' в 1C:ERPУХ
	...
	* Находим контрагента
		...
		И в таблице 'List' количество строк 'равно' 1
		И в таблице 'List' я выбираю текущую строку
		Тогда открылось окно "[ТекNameCounterpartyа] (Counterparty *)"
		И В текущем окне я нажимаю кнопку командного интерфейса "Contracts"
	...
	* Удаляем договор
		...
		Тогда открылась форма с именем 'UniversalListFindExtForm'
		И из выпадающего списка с именем 'FieldSelector' я выбираю точное значение 'Рабочее наименование'
		И в поле с именем 'Pattern' я ввожу текст '[CrntNumber] dated [CurDate]'
		И я меняю значение переключателя с именем 'CompareType' на 'On точному совпадению'
		И я нажимаю на кнопку с именем 'Find'
		И Пока в таблице 'List' количество строк 'больше' 0 Тогда
			* Ставим пометку на удаление
	...
	* Создаем договор
		...
		И в поле с именем 'Number' я ввожу текст '[CrntNumber]'
		И в поле с именем 'Date' я ввожу текст '[CurDate]'
		И из выпадающего списка с именем 'Company' я выбираю по строке '[CrntCompany]'
		И из выпадающего списка с именем 'MutualSettlementsCurrency' я выбираю точное значение '[CrntCurrency]'
	...
	* Закрываем форму
		Когда открылось окно "[ТекNameCounterpartyа] (Counterparty *)"
		И Я закрываю окно "[ТекNameCounterpartyа] (Counterparty *)"				
		Когда открылось окно "[ТекNameПартнера] (Партнер)"
		И Я закрываю окно "[ТекNameПартнера] (Партнер)"
		Тогда открылось окно "Партнеры"
		И Я закрываю окно "Партнеры"				
